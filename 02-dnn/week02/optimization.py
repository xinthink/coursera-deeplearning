...
def update_parameters_with_adam(parameters,
                                grads,
                                v,
                                s,
                                t,
    ...
    for l in range(L):
        ...
        parameters["W" + str(l + 1)] = parameters["W" + str(l + 1)] - learning_rate * \
            v_corrected["dW" + str(l + 1)] / (epsilon + np.sqrt(s_corrected["dW" + str(l + 1)]))
        parameters["b" + str(l + 1)] = parameters["b" + str(l + 1)] - learning_rate * \
            v_corrected["db" + str(l + 1)] / (epsilon + np.sqrt(s_corrected["db" + str(l + 1)]))
        ### END CODE HERE ###
