...
from reg_testCases import *


train_X, train_Y, test_X, test_Y = load_2D_dataset(plot=False)
# print("test_X: shape=%s data=%s" % (test_X.shape, test_X))
print("Shapes: train_X=%s train_Y=%s test_X=%s test_Y=%s" % (train_X.shape, train_Y.shape, test_X.shape, test_Y.shape))
